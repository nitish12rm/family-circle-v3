...
function buildLayout(
  ...
  // Place disconnected non-secondary members
  for (const m of members) {
  ...
  // Place secondary spouses directly beside their primary
  for (const secondaryId of secondaryIds) {
    ...
    if (!sec) continue;
    if (primaryPos) {
      positioned.set(secondaryId, { x: primaryPos.x + NODE_GAP, y: primaryPos.y, member: sec });
    } else {
